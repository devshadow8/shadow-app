...
import { Users, Target, Eye,  Lightbulb,Sparkles, Rocket, BookOpen, Trophy } from 'lucide-react';
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-block px-6 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-full border border-blue-400/30 backdrop-blur-sm mb-4">
                <span className="text-blue-300 font-semibold">✨ Premium Training Institute</span>
              </div>
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Empowering professionals with cutting-edge skills, personalized mentorship, and industry-ready training programs.
              </p>
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-96 h-96">
                  ...
                  {/* Floating Icons */}
                  {[
                    { Icon: BookOpen, position: "top-0 left-1/2 -translate-x-1/2", color: "from-blue-400 to-cyan-400", delay: "0s" },
                    { Icon: Trophy, position: "top-1/4 right-0", color: "from-yellow-400 to-orange-400", delay: "0.5s" },
                    { Icon: Users, position: "bottom-1/4 right-0", color: "from-purple-400 to-pink-400", delay: "1s" },
                    { Icon: Target, position: "bottom-0 left-1/2 -translate-x-1/2", color: "from-green-400 to-emerald-400", delay: "1.5s" },
                    { Icon: Sparkles, position: "bottom-1/4 left-0", color: "from-pink-400 to-rose-400", delay: "2s" },
                    { Icon: Lightbulb, position: "top-1/4 left-0", color: "from-yellow-400 to-amber-400", delay: "2.5s" }
            ...
            {values.map((value, i) => (
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl p-8 border border-white/10 hover:border-white/30 transition-all duration-500 h-full transform hover:-translate-y-2 hover:rotate-1">
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${value.color} flex items-center justify-center mb-6 transform group-hover:scale-110 transition-transform`}>
            ...
            {team.map((member, i) => (
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl p-10 border border-white/10 hover:border-white/30 transition-all duration-500 transform hover:-translate-y-2">
                  <div className={`w-32 h-32 rounded-full bg-gradient-to-r ${member.gradient} mx-auto mb-6 flex items-center justify-center overflow-hidden border-4 border-white/20 transform group-hover:scale-110 transition-transform`}>
